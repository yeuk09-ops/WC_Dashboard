...
{
  "improvementDirection": "**전반적인 개선 방향**\n\n**1. 현황 평가 (전년동기 대비)**\n25.3Q 연결 기준 운전자본은 X억원으로 전년 동기(24.3Q YY억원) 대비 ZZ억원 증가(+AA%)했습니다. 매출은 BB% 증가에 그쳐 운전자본 증가율이 매출 성장률을 상회하고 있어 자금 효율성이 저하되었습니다.\n\n전분기(25.2Q) 대비로는 CC억원 증가하였으나, 전년동기 추세(24.2Q→24.3Q: +DD억원)와 비교 시 계절적 패턴으로 판단됩니다.\n\n**2. 주요 이슈 (법인별)**\n• [법인명]: 전년동기 대비 [항목] XX억원 증가(YY억→ZZ억), [회전율] AA일→BB일로 변화, 매출증가율(CC%) 대비 과다 투입\n• [법인명]: 전년동기 대비 [항목] XX억원 감소(개선), [회전율] DD일 단축, 자금 EE억원 회수 효과\n\n**3. 개선 우선순위 및 전략**\n① [법인/항목]: 전년동기 수준(XX일) 회복 시 약 YY억원 자금 회수 가능\n② [법인/항목]: 전분기 대비 추가 증가 억제 필요, 계절성 감안 시 ZZ억원 감축 목표 (24.4Q 수준 기준)\n\n**4. 예상 개선 효과**\n전년동기 수준 회복 시 총 XX억원, 전분기 대비 개선 시 추가 YY억원의 운전자본 감축이 가능할 것으로 전망됩니다.",
  "actionItems": [
    {
      "priority": "HIGH",
      "label": "재고",
      "issue": "국내(OC) 재고 전년동기 대비 50.2억원 증가(2,420.0억 → 2,470.2억), DIO 3일 증가(62일 → 65일). 매출증가율(5%) 대비 재고증가율(12%)이 과다하여 자금 효율성 저하. 연결 대비 비중 60%로 최우선 관리 필요.",
      "action": "SKU별 재고 회전율 분석 및 Slow-moving 재고 정리. 전년동기(24.3Q) 추세와 비교하여 과다 재고 원인 파악 후 발주 조정.",
      "target": "전년동기 수준(2,420억원, DIO 62일) 회복. 달성 시 약 50억원 자금 회수 가능.",
      "responsible": "국내(OC) 재무팀"
    },
    {
      "priority": "MEDIUM",
      "label": "매출채권",
      "issue": "중국 법인 매출채권 전년동기 대비 15.7억원 증가(81.9억 → 97.6억), DSO 2일 증가. 전분기 대비로는 88.7억에서 증가하여 추세적 악화 확인됨.",
      "action": "대금 회수 프로세스 점검 및 연체 채권 관리 강화. 전분기(25.2Q) 수준으로 우선 개선 후 전년동기 수준 목표.",
      "target": "1단계: 전분기 수준(88.7억원) 회복 → 9억원 회수\n2단계: 전년동기 수준(81.9억원) 회복 → 추가 6.8억원 회수\n※ 계절성 검토 필요",
...
- **5점 이내 유사 점수는 같은 레벨로 분류**
  * 예: 85점, 83점, 81점 → 모두 HIGH
- **5% 미만 비중 법인은 점수와 무관하게 무조건 LOW**

**예시:**
이슈A: 증감률 +25%(40점) + CCC +35일(25점) + 비중 25%(15점) = **80점** → HIGH
이슈B: 증감률 +15%(30점) + CCC +15일(15점) + 비중 15%(10점) = **55점** → MEDIUM
이슈C: 증감률 +8%(20점) + CCC +8일(10점) + 비중 3%(0점) = **30점** → LOW
